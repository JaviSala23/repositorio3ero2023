...
celesteBajo = np.array([90, 100, 20], np.uint8)
celesteAlto = np.array([125, 255, 255], np.uint8)
...
colorRosa = (128,0,255)
colorVerde = (0,255,36)
colorBorrar = (0,0,0) #goma color negro
...
while True:
    ...
    cv2.rectangle(frame,(200,0),(250,50),colorBorrar,grosorBorrar)
        ...
        if area > 3000:
            ...
            if x1 is not None:
                ...
                if 200 < x2 < 250 and 0 < y2 < 50:
                    color = colorBorrar # Color del goma
                    grosorAmarillo = 2
                    grosorRosa = 2
                    grosorVerde = 2
                    grosorCeleste = 2
